...
<p align="center">If you want to discuss about something, then you can ask on my <a href="">Discord Server</a>.</p>

<p align="center"> 
    <a href="https://RAJSINGH-Bitian.github.io" target="_blank">
...
To view a live example, **[click here](https://RAJSINGH-Bitian.github.io/)**
...
- After the successful installation of `nodejs` and `npm`, clone the repository into your local system using below command:
  - ```bash
     git clone https://github.com/RAJSINGH-Bitian/Raj-s-Portfolio.git
    ```
...
Note here that if you click [my portfolio](https://RAJSINGH_Bitian.github.io), you can see animating the logo at the beginning. I have designed that logo in [`Figma`](https://www.figma.com/) and then animated it using css.
